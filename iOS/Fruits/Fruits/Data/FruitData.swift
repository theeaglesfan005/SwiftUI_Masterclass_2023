...
let fruitsData: [Fruit] = [
    Fruit(
        title: "Grape",
        headline: "Grapes are known as nature's candy because of their sweetness.",
        image: "grape",
        gradientColors: [Color("ColorGrapeLight"), Color("ColorGrapeDark")],
        description: """
          A grape is a fruit, botanically a berry, of the deciduous woody vines of the flowering plant genus Vitis. Grapes are a non-climacteric type of fruit, generally occurring in clusters. They have a leathery covering and a fleshy inside, similar to blueberries.

          They come in three different colors: red, green, and blue-black.

          The cultivation of grapes began perhaps 8,000 years ago, and the fruit has been used as human food over history. Eaten fresh or in dried form (as raisins, currants and sultanas), grapes also hold cultural significance in many parts of the world, particularly for their role in winemaking.

          There are more than 8,000 grape varieties from about 60 species. The main types are American and European.

          USES

          Grapes can be eaten fresh, but they are also used to make raisins, juice, jams, vinegar, oil, and wine.
          ...
          Grapes are good sources of vitamin C and fiber. Red grapes also contain flavonoids, which help protect our heart, arteries and blood vessels.
          """,
        nutrition: ["288 kJ (69 kcal)","15.48 g","0.16 g","0.72 g","B1, B2, B3, B5, B6, B9, C, E, K","Calcium, Choline, Iron, Magnesium, Manganese, Phosphorus, Potassium, Sodium, Zinc"]
      ),
    Fruit(
        title: "Blueberry",
