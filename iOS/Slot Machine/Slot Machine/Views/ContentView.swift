...
struct ContentView: View {
    ...
    @State private var startedPlaying: Bool = false
    
    @State private var startingCoins: Int = 1000
        ...
        ZStack {
            ...
            if $showingModal.wrappedValue {
                ZStack {
                    ...
                    .cornerRadius(20)
                    .shadow(color: Color("ColorTransparentBlacj"), radius: 6, x: 0, y: 8)
                    .opacity($animatingModal.wrappedValue ? 1 : 0)
                    .offset(y: $animatingModal.wrappedValue ? 0 : -100)
                    .animation(Animation.spring(response: 0.6, dampingFraction: 1.0, blendDuration: 1.0), value: false)
                    .onAppear(perform: {
